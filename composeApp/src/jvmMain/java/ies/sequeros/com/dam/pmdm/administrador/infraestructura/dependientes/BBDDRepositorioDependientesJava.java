...
public  class BBDDRepositorioDependientesJava {
    ...
    //public BBDDRepositorioDependientesJava(DataBaseConnection db) throws Exception {//Pasar la conexion a la base de datos
    public BBDDRepositorioDependientesJava(DataBaseConnection db){
    ...
    public void close(){
        ...
        // La conexión se cierra desde fuera
